...
use Modules\GeneralSetting\Transformers\UserNotificationSettingResource;
/**
* @group Notifications
*
...
class NotificationController extends Controller
{
    ...
    public function userNotifications(Request $request)
    {
        ...
        if($notifications){
            return response()->json([
                'notifications' => \Modules\GeneralSetting\Transformers\UserNotificationResource::collection($notifications)
            ],200);
        }else{
            return response()->json([
    ...
    public function notificationSetting(Request $request){
        ...
        return response()->json([
            'notifications' => UserNotificationSettingResource::collection($userNotificationSettings),
    ...
    public function notificationSettingUpdate(Request $request){
       ...
       $update = $this->customerNotificationSettingService->updateSettingForAPI($request);
       if($update){
            return response()->json([
                'msg' => trans('app.updated successfully')
            ],202);

       }else{
           return response()->json([
                'msg' => trans('app.Not updated')
            ],501);
       }
    }
