    ...
    <div class="modal-dialog modal_800px modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="create_form" method="post" action="{{ route('page_builder.pages.store') }}">
                    @csrf
                    <div class="row">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="element{{$language->code}}">
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field page_title" @if($key == 0) oninput="convertToSlug(this.value,'#add_slug')" @endif type="text" id="title_title_{{$language->code}}" name="title[{{$language->code}}]" autocomplete="off" value="{{ old('title.'.$language->code) }}" placeholder="{{__('page-builder.Title')}}">
                    ...
                    <div class="col-lg-12">
                        <div class="primary_input mb-15">
                            ...
                            <input class="primary_input_field page_title" id="title" name="title" oninput="convertToSlug(this.value,'#add_slug')" placeholder="{{__('page-builder.Title')}}" type="text" value="">
                    ...
                    @endif
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input mb-15">
                                <label class="primary_input_label" for="add_slug"> {{__('page-builder.Slug')}} <span class="required_mark_theme">*</span></label>
                                <input class="primary_input_field page_slug" id="add_slug" name="slug" placeholder="{{__('page-builder.Slug')}}" type="text" value="{{old('slug')}}">
