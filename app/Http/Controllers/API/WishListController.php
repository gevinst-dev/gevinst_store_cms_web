...
class WishListController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if(count($products) > 0){
            ...
            return response()->json([
                'message' =>  trans('app.Wishlist is empty')
            ],404);
        }
    ...
    public function store(Request $request){
        ...
        if($product == 1){
            return response()->json([
                'message' => trans('app.Product added to wishlist')
            ],201);
        }elseif($product == 3){
            return response()->json([
                'message' => trans('app.Product already in wishlist')
            ],409);
        }else{
            return response()->json([
    ...
    public function destroy(Request $request){
        ...
        if($result){
            return response()->json([
                'message' => trans('app.product removed from wishlist successfully')
            ],202);
        }else{
            return response()->json([
                'message' => trans('app.product not found')
            ],404);
        }
    }
}
